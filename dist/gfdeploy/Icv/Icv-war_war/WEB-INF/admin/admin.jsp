                        ...
                        <section class="sidebar">
                            ...
                            <div class="user-panel">
                                ...
                                <div class="pull-left info">
                                    <p>Hello, <c:out value="${sessionScope.Profile.getFirstsName()}"></c:out></p>
                            ...
                            <ul class="sidebar-menu">
                                ...
                                <li>
                                    <a href="PublicControl?redirect=managerStories">
                    ...
                    <div class="row" style="margin-bottom:5px;">
                        ...
                        <div class="col-md-3">
                            <div class="sm-st clearfix">
                                ...
                                <div class="sm-st-info">
                                    <span><c:out value="${sessionScope.totalUser}"></c:out>></span>     
                                    Total User
                                </div>
                            </div>
                        </div>
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="panel">
                                <header class="panel-heading">          <!--List admin-->
                                    Teammates
                                </header>
...
<script type="text/javascript">
    $(function() {
            ...
            $(window).load(function(){
               ...
               xhttp.open('Get','ViewServlet?viewAction=admin',true);
               xhttp.send();
